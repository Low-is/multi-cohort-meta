...
# Save results
saveRDS(dna_pData_cond, "../pdata/dna_pData_with_condition.rds")
saveRDS(rna_pData_cond, "../pdata/rna_pData_with_condition.rds")
# Saving as csv
write.csv(dna_pData_cond, "../pdata/dna_pData_with_condition.csv")
write.csv(rna_pData_cond, "../pdata/rna_pData_with_condition.csv")
